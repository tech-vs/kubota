  ...
  return (
    <>
      <div className='page' data-size='A4'>
        ...
        <div className='section fs-11 bold'>
          <table>
            <tbody className='fs-11 bold'>
              <tr>
                <td style={{ width: '30%' }}>Engine Packing Check Sheet</td>
                <td style={{ width: '30%' }}>
                  Packing Date : <Moment format='YYYY/MM/DD HH:mm'>{content.created_at || '-'}</Moment>
                </td>
                <td style={{ width: '30%' }}>Distributor : THAILAND</td>
              </tr>
            </tbody>
          </table>
        ...
        <div className='section'>
          <div className='fs-11 bold'>
            Appearance check sheet (For Export engine only) [Mark =&gt; O : OK , X : NG ]
          </div>
              ...
              <table>
                <thead className='fs-11 bold'>
                  <tr>
                    ...
                    <td style={{ width: '60%' }}>Check List</td>
                  </tr>
                </thead>
                <tbody>
                  {table.map((m, i) => (
